  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
      ...
      <section className="orb-floating-panel p-6 text-white">
        <p className="orb-kicker text-[11px] font-black uppercase tracking-[0.24em]">{orbProductCopy.brandLine}</p>
        <h2 className="orb-title-glow mt-3 text-4xl font-black tracking-[-0.07em]">{orbProductCopy.standalonePrompt}</h2>
