...
export default function IndiCareOsPage() {
  return (
    <IndiCareOsShell
      eyebrow="IndiCare OS"
      ...
      contextLabel="IndiCare OS"
      nav={[
        { label: 'ORB Residential', href: '/' },
        { label: 'Choose home', href: '/homes' },
        { label: 'Young person story', href: '/young-people/1' },
        { label: 'OS ORB', href: '/assistant/orb' }
      ]}
    >
        ...
        <section className="ic-hero-card">
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', marginTop: '1.4rem' }}>
              ...
              <Link className="ic-secondary-action" href="/assistant/orb">Ask OS ORB</Link>
            </div>
          </div>
        </section>
