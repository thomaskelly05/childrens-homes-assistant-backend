...
export default function DocumentTemplatesPage() {
  return (
    <div className="space-y-6">
      ...
      <DocumentTemplateGrid templates={documentTemplates} hrefFor={(template) => template.scope === 'child' ? `/young-people/yp-1/documents/new?template=${template.templateId}` : `/documents/new?scope=${template.scope}&template=${template.templateId}`} />
    </div>
  )
}
