        ...
        <aside className="space-y-4">
          ...
          <Card>
            ...
            <div className="grid gap-2">
              ...
              <Link href="/inspection-readiness" className="rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-black text-slate-700">Inspection evidence preparation</Link>
