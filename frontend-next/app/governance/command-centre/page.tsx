  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        action={<Link prefetch={false} href="/inspection-readiness" className="rounded-2xl bg-blue-600 px-5 py-3 text-sm font-black text-white shadow-lg shadow-blue-500/30">Open Inspection evidence preparation</Link>}
      />
      ...
      <section className="grid gap-4 md:grid-cols-5">
        <StatCard label="Inspection evidence preparation" value={text(summary.inspection_readiness, 'Review')} detail="Backend readiness forecast" href="/inspection-readiness" />
