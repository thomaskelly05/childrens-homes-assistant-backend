...
import { childCarePlanningHref, childDocumentsHref, childRecordHref } from '@/lib/navigation/scope-routes'
  ...
  return (
    <div data-testid="child-workspace-client" className="mobile-child-workspace space-y-5 md:space-y-6">
      ...
      <div className="space-y-5 md:space-y-6">
        ...
        <Section
          eyebrow="Today"
          title="One-page profile: what adults need to know today"
          description="Presentation, voice, strengths, risks, routines, plans, appointments and actions — all kept close before anyone records."
        ...
        >
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <article className="rounded-[24px] border border-slate-100 bg-white p-4">
              <p className="text-[10px] font-black uppercase tracking-[0.16em] text-slate-400">Current support picture</p>
        ...
        <Section
          eyebrow="Support profile"
          title="What matters, what helps and how adults should respond"
          description="Keep the young person’s strengths, communication, routines and support needs visible before forms, risks or compliance."
        ...
        <section data-testid="child-workspace-journey-nav" className="space-y-4">
          <div>
            <p className="text-[11px] font-black uppercase tracking-[0.22em] text-sky-700">Connected journey</p>
            <h2 className="mt-1 text-xl font-black text-slate-950 md:text-2xl">Everything is clickable, reviewable and linked</h2>
            <p className="mt-2 text-sm text-slate-600">Open records, plans, documents, actions and chronology items for source detail, editing and manager follow-up where permitted.</p>
          </div>
        ...
        >
          {sourcesOpen ? 'Hide' : 'Show'} connected records and evidence sources
        </button>
        {sourcesOpen ? (
