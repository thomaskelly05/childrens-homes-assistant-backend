...
export function buildOrbVoiceDiagSnapshot() {
  ...
  return {
    ...
    browserName: browserDiagnostics.browserName,
    safariDetected: browserDiagnostics.safariDetected,
    lastRecognitionError: browserDiagnostics.lastRecognitionError,
    lastRecognitionErrorMessage: browserDiagnostics.lastRecognitionErrorMessage,
    serverActionUsedForVoice: browserDiagnostics.serverActionUsedForVoice,
    clientFetchUsedForVoice: browserDiagnostics.clientFetchUsedForVoice,
    staleServerActionErrorDetected: browserDiagnostics.staleServerActionErrorDetected,
    recommendedFallback: browserDiagnostics.recommendedFallback,
    selectedTransport: browserDiagnostics.selectedTransport,
    activeTransport: browserDiagnostics.activeTransport,
    supportedTransports: browserDiagnostics.supportedTransports,
    rejectedTransports: browserDiagnostics.rejectedTransports,
    browserFamily: browserDiagnostics.browserFamily,
    firefoxDetected: browserDiagnostics.firefoxDetected,
    chromeDetected: browserDiagnostics.chromeDetected,
    secureContext: browserDiagnostics.secureContext,
    getUserMediaSupported: browserDiagnostics.getUserMediaSupported,
    lastStartAttemptAt: browserDiagnostics.lastStartAttemptAt,
    resolvedTranscriptLength: browserDiagnostics.resolvedTranscriptLength,
    serverTranscriptionAttempted: browserDiagnostics.serverTranscriptionAttempted,
    serverTranscriptionStatus: browserDiagnostics.serverTranscriptionStatus,
    serverTranscriptionError: browserDiagnostics.serverTranscriptionError,
    mediaRecorderStarted: browserDiagnostics.mediaRecorderStarted,
    mediaRecorderStopped: browserDiagnostics.mediaRecorderStopped,
    recordedAudioSizeBytes: browserDiagnostics.recordedAudioSizeBytes,
    ttsConfigured: browserDiagnostics.ttsConfigured,
    appleOrBrowserFallbackUsed: browserDiagnostics.appleOrBrowserFallbackUsed,
    bargeInEnabled: browserDiagnostics.bargeInEnabled,
    bargeInTriggered: browserDiagnostics.bargeInTriggered,
    interruptReason: browserDiagnostics.interruptReason,
    speechCancelledBeforeListen: browserDiagnostics.speechCancelledBeforeListen,
    staleSpeakingStateDetected: browserDiagnostics.staleSpeakingStateDetected,
    userFacingMessage: browserDiagnostics.userFacingMessage,
    sessionHttpStatus,
