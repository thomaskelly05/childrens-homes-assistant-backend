...
const SHARED_PROMPTS = {
  ...
  avoid: [
    ...
    'Next Steps, Follow-up or Recommendations when Outcome / Handover already covers handover',
    'Repeating the same observed outcome in multiple sections',
    "[End of record], END OF RECORD, <end> or similar end markers",
