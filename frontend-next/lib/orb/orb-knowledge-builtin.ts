...
export const ORB_KNOWLEDGE_BUILTIN_RESOURCES: OrbKnowledgeBuiltinResource[] = [
  ...
  res('sg-restraint', 'Restraint / physical intervention', 'Safeguarding guidance', 'safeguarding', 'built-in'),
  res('sg-complaints', 'Complaints', 'Safeguarding guidance', 'safeguarding', 'built-in'),
  res('sg-medication', 'Medication / health safeguarding', 'Safeguarding guidance', 'safeguarding', 'built-in'),
  res('sg-equality', 'Equality, diversity and neurodiversity', 'Practice guidance', 'safeguarding', 'built-in'),
  res('sg-child-voice', "Children's voice", 'Practice guidance', 'safeguarding', 'built-in'),
  ...
  res('lr-recording', 'Recording quality', 'Practice guidance', 'learning', 'built-in'),
  res('lr-supervision', 'Supervision', 'Practice guidance', 'learning', 'built-in'),
  res('lr-reg44', 'Regulation 44 visits', 'Regulatory', 'inspection', 'built-in'),
  res('lr-reg45', 'Regulation 45 reports', 'Regulatory', 'inspection', 'built-in'),
  res('lr-recording-share', 'Recording and information sharing', 'Practice guidance', 'learning', 'built-in'),
