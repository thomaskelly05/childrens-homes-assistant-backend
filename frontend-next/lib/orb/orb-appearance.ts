 ...
 */
export const ORB_APPEARANCE_BOOTSTRAP_SCRIPT = `(function(){try{var M=${JSON.stringify(ORB_APPEARANCE_MIGRATION_KEY)};var RM=${JSON.stringify(ORB_RESIDENTIAL_APPEARANCE_MIGRATION_KEY)};var K=${JSON.stringify(ORB_APPEARANCE_STORAGE_KEY)};var DEF=${JSON.stringify(ORB_RESIDENTIAL_DEFAULT_APPEARANCE)};var LH=${ORB_SYSTEM_LIGHT_START_HOUR};var DH=${ORB_SYSTEM_DARK_START_HOUR};function timeTheme(){var h=new Date().getHours();return h>=LH&&h<DH?'light':'dark';}function applyThemeClass(el,theme){if(!el||!el.classList)return;el.classList.remove('orb-theme-light','orb-theme-dark');el.classList.add(theme==='light'?'orb-theme-light':'orb-theme-dark');}if(localStorage.getItem(M)!=='done'&&!localStorage.getItem(K)){localStorage.setItem(K,'system');localStorage.setItem(M,'done');}if(localStorage.getItem(RM)!=='done'&&!localStorage.getItem(K)){localStorage.setItem(K,DEF);localStorage.setItem(RM,'done');}var mode=localStorage.getItem(K)||DEF;var theme=mode==='dark'?'dark':mode==='light'?'light':timeTheme();document.documentElement.setAttribute('data-orb-residential','1');document.documentElement.setAttribute('data-orb-visual-system','v2');document.documentElement.setAttribute('data-orb-appearance',mode);document.documentElement.setAttribute('data-orb-appearance-mode',mode);document.documentElement.setAttribute('data-orb-theme',theme);document.documentElement.setAttribute('data-orb-system-theme',theme);document.documentElement.style.colorScheme=theme;applyThemeClass(document.documentElement,theme);document.body&&(document.body.setAttribute('data-orb-appearance',mode),document.body.setAttribute('data-orb-appearance-mode',mode),document.body.setAttribute('data-orb-theme',theme),applyThemeClass(document.body,theme));}catch(e){var fb=${JSON.stringify(ORB_RESIDENTIAL_DEFAULT_THEME)};document.documentElement.setAttribute('data-orb-residential','1');document.documentElement.setAttribute('data-orb-visual-system','v2');document.documentElement.setAttribute('data-orb-appearance',${JSON.stringify(ORB_RESIDENTIAL_DEFAULT_APPEARANCE)});document.documentElement.setAttribute('data-orb-appearance-mode',${JSON.stringify(ORB_RESIDENTIAL_DEFAULT_APPEARANCE)});document.documentElement.setAttribute('data-orb-theme',fb);document.documentElement.setAttribute('data-orb-system-theme',fb);document.documentElement.style.colorScheme=fb;document.documentElement.classList.add('orb-theme-'+fb);document.body&&(document.body.setAttribute('data-orb-appearance',${JSON.stringify(ORB_RESIDENTIAL_DEFAULT_APPEARANCE)}),document.body.setAttribute('data-orb-appearance-mode',${JSON.stringify(ORB_RESIDENTIAL_DEFAULT_APPEARANCE)}),document.body.setAttribute('data-orb-theme',fb),document.body.classList.add('orb-theme-'+fb));}})();`
