...
export function noScopeNavigation(): ScopeNavItem[] {
  return [
    ...
    { label: 'Recent young people', href: '/select-scope#recent-children', icon: UserRound, prefetch: false, testId: 'scope-nav-recent-children' },
...
export function homeScopePrimaryNavigation(homeId: string | number): ScopeNavItem[] {
  ...
  return [
    ...
    { label: 'Young people', href: homeChildrenHref(hid), icon: UserRound, prefetch: false, testId: 'scope-nav-home-children' },
    { label: 'Handover', href: homeHandoverHref(hid), icon: ClipboardCheck, prefetch: false, testId: 'scope-nav-home-handover' },
    { label: 'Manager review', href: homeRecordingReviewsHref(hid), icon: ClipboardCheck, prefetch: false, testId: 'scope-nav-home-reviews' },
...
export function homeScopeMoreNavigation(homeId: string | number): ScopeNavItem[] {
  ...
  return [
    ...
    { label: 'Safeguarding themes', href: homeSafeguardingHref(hid), icon: ShieldCheck, prefetch: false, testId: 'scope-nav-home-safeguarding' },
    ...
    { label: 'SCCIF evidence', href: homeSccifHref(hid), icon: FileText, prefetch: false, testId: 'scope-nav-home-sccif' },
    ...
    { label: 'ORB intelligence', href: homeOrbHref(hid), icon: Sparkles, prefetch: false, testId: 'scope-nav-home-orb' }
  ]
}
...
export function childScopePrimaryNavigation(childId: string | number): ScopeNavItem[] {
  ...
  return [
    { label: 'Story', href: childWorkspaceHref(cid), icon: UserRound, prefetch: false, testId: 'scope-nav-child-overview' },
    { label: 'Today', href: childWorkspaceHref(cid), icon: Gauge, prefetch: false, testId: 'scope-nav-child-today' },
    ...
    { label: 'Evidence checks', href: childAlertsHref(cid), icon: Bell, prefetch: false, testId: 'scope-nav-child-alerts' }
  ]
}
...
export function childScopeMoreNavigation(childId: string | number): ScopeNavItem[] {
  ...
  return [
    ...
    { label: 'Life story', href: childLifeEchoHref(cid), icon: Sparkles, prefetch: false, testId: 'scope-nav-child-lifeecho' },
    ...
    { label: 'Voice', href: childVoiceHref(cid), icon: UserRound, prefetch: false, testId: 'scope-nav-child-voice' },
    ...
    { label: 'Health', href: childHealthMedicationHref(cid), icon: HeartPulse, prefetch: false, testId: 'scope-nav-child-health' },
    { label: 'Education', href: childEducationHref(cid), icon: FileText, prefetch: false, testId: 'scope-nav-child-education' },
    { label: 'Family & relationships', href: childFamilyTimeHref(cid), icon: UserRound, prefetch: false, testId: 'scope-nav-child-family-time' },
...
export function scopeNavigationFor(scopeType: OsScopeType, ids: { homeId?: string | number | null; childId?: string | number | null }): ScopeNavItem[] {
