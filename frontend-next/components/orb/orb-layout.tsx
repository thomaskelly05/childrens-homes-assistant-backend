...
export function OrbLayout({
  ...
  return (
    <>
      ...
      <div
        className={`relative flex min-h-0 flex-1 ${residentialSurface ? 'orb-chat-shell orb-full-viewport-workspace orb-residential-app-shell__workspace' : ''}`}
        data-orb-full-viewport-workspace={residentialSurface ? 'true' : undefined}
        data-orb-residential-app-shell-workspace={residentialSurface ? 'true' : undefined}
      ...
      >
        <aside
          ...
          data-orb-residential-sidebar-v2={residentialSurface ? 'true' : undefined}
        >
          {sidebar}
        </aside>

        <div className="orb-chat-main orb-full-viewport-main orb-residential-main flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
          {mobileHeader}
