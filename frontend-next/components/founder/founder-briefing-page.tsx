...
import { ArrowLeft, Briefcase, Shield, Sparkles, TrendingUp, TriangleAlert } from 'lucide-react'

import { getChiefOfStaffBriefing } from '@/lib/founder/intelligence-service'
import {
  calculateAiCost,
...
export function FounderBriefingPage() {
  ...
  const readiness = calculateOfstedReadiness(mockReadinessMetrics)
  ...
  const snapshotSections = [
    {
      ...
      content: `MRR at £${mockProviderAnalytics.totalMrr.toLocaleString('en-GB')} (+${mockProviderAnalytics.mrrTrendPercent}% MoM). ${mockProviderAnalytics.totalProviders} providers across ${mockProviderAnalytics.totalHomes} homes. Gross margin ${aiCost.grossMargin}.`
    },
    {
      icon: Briefcase,
      title: 'Growth',
      ...
      <div className="mx-auto max-w-[1000px] space-y-8 px-4 py-8 pb-16 md:px-8">
        ...
        <header className="founder-surface rounded-[32px] border border-white/10 bg-white/[0.04] p-8 shadow-[0_28px_90px_rgba(0,0,0,0.45)] backdrop-blur-xl">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-slate-400">
            Your daily intelligence briefing, generated by the Chief of Staff Agent from live platform signals.
          </p>
