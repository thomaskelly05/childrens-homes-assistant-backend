...
export function CareHubInspectionReadiness() {
  ...
  useEffect(() => {
    ...
    void fetchWithOsCache(
      osRequestDedupeKey('/intelligence/inspection evidence preparation/dashboard'),
      () => getInspectionReadinessDashboard(),
      30000
    ).then((result) => {
      if (!result.ok || !result.data) return
  ...
  return (
    <section
      data-testid="care-hub-inspection evidence preparation"
      className="rounded-[28px] border border-blue-100 bg-gradient-to-br from-white to-blue-50/50 p-6 shadow-sm"
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="text-[10px] font-black uppercase tracking-[0.22em] text-blue-700">Inspection evidence preparation</p>
        ...
        <Link
          ...
          data-testid="care-hub-open-inspection evidence preparation"
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <Link
          href="/intelligence/inspection evidence preparation?pack=reg44"
        ...
        <Link
          href="/intelligence/inspection evidence preparation?pack=reg45"
