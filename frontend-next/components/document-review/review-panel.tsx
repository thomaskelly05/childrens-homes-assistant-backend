  ...
  return (
    <aside className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
        <p>Status flow: draft, autosaved, submitted, under review, amendment requested, approved, escalated, archived.</p>
        <p>Owner: {template.ownerRole}. Review: {template.reviewFrequency}.</p>
        <p className="rounded-2xl bg-amber-50 p-3 font-bold text-amber-800">Review actions call the live document-system API. If the backend is unavailable, the document is not submitted.</p>
      </div>
    </aside>
  )
}
