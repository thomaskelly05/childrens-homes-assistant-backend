...
function OrbLoginPanel({
  ...
  return (
    <div
      className={`orb-residential-root orb-login-root orb-login-full-viewport orb-login-enterprise ${ORB_MOBILE_VIEWPORT_CLASS} ${themeClass} min-h-[100dvh] min-h-[100svh]`}
      data-orb-login-page
      data-orb-login-full-viewport
      data-orb-login-enterprise
    ...
    >
      <div
        className="orb-login-shell orb-login-flagship-shell orb-login-full-viewport-shell orb-login-enterprise-shell grid min-h-0 w-full grid-cols-1 px-5 py-4 sm:px-8 lg:grid-cols-[58%_42%] lg:gap-0 lg:px-0 lg:pb-0 lg:pt-0"
