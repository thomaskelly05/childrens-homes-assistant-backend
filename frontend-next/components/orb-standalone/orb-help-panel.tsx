...
export function OrbHelpPanel({ open, onClose }: { open: boolean; onClose: () => void }) {
  return (
    <OrbStandalonePanelShell
      ...
      layout="center"
    >
      <div className="space-y-4 p-4 orb-product-modal-v2" data-orb-help-panel data-orb-flagship-product-modal="true" data-orb-product-panel-modal="true" data-orb-product-modal-v2="true">
