  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <header className="orb-mobile-station-header sticky top-0 z-10 flex shrink-0 items-center justify-between gap-3 border-b border-[var(--orb-line)]/40 bg-[var(--orb-surface)] px-4 py-2 pt-[max(0.25rem,env(safe-area-inset-top))] sm:px-5 sm:py-3" data-orb-mobile-station-header data-orb-mobile-shell-top-bar>
