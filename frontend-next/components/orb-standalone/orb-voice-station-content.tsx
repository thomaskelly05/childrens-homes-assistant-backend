...
export function OrbVoiceStationContent({
  ...
  return (
    ...
    >
      <div className="orb-voice-station-content__scroll min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 pt-4 pb-2 md:px-6 md:pt-6">
      ...
      >
        <div className="mx-auto w-full max-w-lg">{controls}</div>
      </div>
    </div>
  )
}
