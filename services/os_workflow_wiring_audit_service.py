...
WORKFLOW_CONTRACTS: tuple[WorkflowContract, ...] = (
    ...
    WorkflowContract("risk", "Risk assessment", "risk_assessments", "risk_assessments", "risk", "/young-people/{young_person_id}/risk", "/young-people/{young_person_id}/risk-assessments", "/young-people/risk-assessments/{record_id}", "/young-people/risk-assessments/{record_id}", assistant_route="/young-people/{young_person_id}/risk"),
