    ...
    *, include_headings: bool = True, prompt_text: str = ""
    ...
    lines = [
        ...
        *[f"   • {concept}" for concept in PREFERRED_THERAPEUTIC_CONCEPTS],
        ...
        "",
        "14. Do not duplicate Outcome and Outcome / Handover headings in simple daily records.",
        "",
        "15. For simple daily records, prefer 2–3 content sections — weave child voice naturally; no redundant Follow-up when handover covers next action.",
        "",
        "16. Use children's home safeguarding language — do not default to DSL or Designated Safeguarding Lead unless the user supplied that term.",
        "",
        "17. For ordinary daily records without safeguarding cues, do not add Safeguarding Note, automatic escalation, or disproportionate safeguarding sections.",
        "",
        "18. Do not use 'Staff on Duty' — use Adults involved with Adult [initials] when supplied.",
        "",
        ADULT_IDENTITY_PRINCIPLE,
        "",
        RECORD_HEADING_DISCIPLINE_PRINCIPLE,
