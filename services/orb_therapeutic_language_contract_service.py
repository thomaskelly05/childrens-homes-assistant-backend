    ...
    *, include_headings: bool = True, prompt_text: str = ""
    ...
    lines = [
        ...
        *[f"   • {concept}" for concept in PREFERRED_THERAPEUTIC_CONCEPTS],
        ...
        "",
        "9. Return the record only — no trailing commentary such as 'This record captures…' unless the user asks why the wording is better.",
        "",
        "10. Preserve direct child quotes exactly — do not add 'This indicates…' interpretation after quotes in simple daily records.",
        "",
        "11. Do not claim internal emotional impact (feel safe and comfortable, felt supported, helped regulate) unless supported by input.",
        "",
        "12. Do not state that an adult's approach made the child feel safe, supported, reassured or regulated unless the child directly said this — describe what the adult did and what was observed instead.",
        "",
        "13. Do not add phrases such as 'indicating a positive shift in mood' or 'showing emotional regulation' — use observed presentation such as 'appeared calmer'.",
        "",
        "14. Use complete sentences — do not join separate record sentences without punctuation.",
        "",
        "15. Do not use 'In response to Child A's feelings' unless the child directly stated a feeling — prefer 'In response,' followed by the adult action.",
        "",
        "16. Do not add 'as the evening progressed' or similar timeline wording unless the user provided that chronology.",
        "",
        "17. Prefer 'appeared calmer before bedtime' where the input states this — not 'seemed more settled' or 'seemed relaxed'.",
        "",
        "18. Do not end records with markdown separator lines (—, ___, ***).",
        "",
        "19. Do not duplicate Outcome and Outcome / Handover headings in simple daily records.",
        "",
        "20. For simple daily records, prefer 2–3 content sections — weave child voice naturally; no redundant Follow-up when handover covers next action.",
        "",
        "21. Do not include Next Steps, Follow-up or Recommendations in a simple daily record when Outcome / Handover already states the handover or next action.",
        "",
        "22. Do not repeat the same observed outcome in multiple sections — keep timed observations in Outcome / Handover only.",
        "",
        "23. Do not include '[End of record]', 'END OF RECORD', '<end>' or any end marker in record outputs.",
        "",
        "24. Use children's home safeguarding language — do not default to DSL or Designated Safeguarding Lead unless the user supplied that term.",
        "",
        "25. For ordinary daily records without safeguarding cues, do not add Safeguarding Note, automatic escalation, or disproportionate safeguarding sections.",
        "",
        "26. Do not use 'Staff on Duty' — use Adults involved with Adult [initials] when supplied.",
        "",
        ADULT_IDENTITY_PRINCIPLE,
        "",
        RECORD_HEADING_DISCIPLINE_PRINCIPLE,
