...
ORB_KNOWLEDGE_SOURCE_PACKS: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": "academy_learning",
        "pack_key": "academy_learning",
        "title": "Academy learning themes",
        "source_type": "workforce_learning",
        "description": "Generic module, workbook and workforce learning principles — not live Academy enrolments or learner records.",
        "source_label": "Academy learning knowledge (standalone-safe)",
        "reliability": "built_in_workforce_learning",
        "applies_to_modes": ["Staff Coach", "Ask ORB"],
        "short_citation_label": "Academy learning",
        "guidance_notes": "Do not reference live learner portfolios or OS Academy tables.",
        "live_retrieved": False,
        "category": "workforce",
    },
    {
        "id": "nvq_diploma_support",
        "pack_key": "nvq_diploma_support",
        "title": "NVQ / diploma support",
        "source_type": "qualification_support",
        "description": "Residential childcare diploma evidence mapping, reflective accounts and assessor boundaries.",
        "source_label": "NVQ diploma support knowledge",
        "reliability": "built_in_qualification_support",
        "applies_to_modes": ["Staff Coach", "Ask ORB"],
        "short_citation_label": "NVQ diploma support",
        "guidance_notes": "Never fabricate workplace evidence; preserve learner authenticity.",
        "live_retrieved": False,
        "category": "workforce",
    },
    {
        "id": "workforce_development",
        "pack_key": "workforce_development",
        "title": "Workforce development",
        "source_type": "workforce_learning",
        "description": "Supervision, training, competence and staff learning in children's homes.",
        "source_label": "Workforce development knowledge",
        "reliability": "built_in_workforce_development",
        "applies_to_modes": ["Staff Coach", "Manager Copilot", "Ask ORB"],
        "short_citation_label": "Workforce development",
        "live_retrieved": False,
        "category": "workforce",
    },
    {
        "id": "qualification_evidence",
        "pack_key": "qualification_evidence",
        "title": "Qualification evidence mapping",
        "source_type": "qualification_support",
        "description": "Naturally occurring evidence, criteria themes and portfolio authenticity.",
        "source_label": "Qualification evidence knowledge",
        "reliability": "built_in_qualification_evidence",
        "applies_to_modes": ["Staff Coach", "Ask ORB"],
        "short_citation_label": "Qualification evidence",
        "live_retrieved": False,
        "category": "workforce",
    },
    {
        "id": "reflective_practice_learning",
        "pack_key": "reflective_practice_learning",
        "title": "Reflective practice learning",
        "source_type": "reflective_practice",
        "description": "Reflective accounts, supervision reflections and incident-to-learning structure.",
        "source_label": "Reflective practice learning",
        "reliability": "built_in_reflective_practice",
        "applies_to_modes": ["Staff Coach", "Reflect", "Ask ORB"],
        "short_citation_label": "Reflective practice",
        "live_retrieved": False,
        "category": "workforce",
    },
    {
