...
if (recordType === "achievement_record") {
return {
title: item?.id ? "Edit achievement" : "New achievement",
subtitle: "Capture progress, strengths and success.",
guidance: "Record what happened, why it mattered, and where possible include the young person’s voice.",
prompts: [
"What was achieved?",
"Why does it matter?",
"How did the young person experience it?",
],
sections: [
{
title: "Achievement details",
fields: [
{ name: "achievement_date", label: "Date", type: "date", value: item.achievement_date || today },
{ name: "achievement_type", label: "Achievement type", type: "text", value: item.achievement_type || "" },
{ name: "title", label: "Title", type: "text", value: item.title || "" },
{ name: "source", label: "Source", type: "text", value: item.source || "" },
{ name: "significance", label: "Significance", type: "text", value: item.significance || "" },
{ name: "linked_plan_id", label: "Linked plan ID", type: "number", value: item.linked_plan_id || "" },
{ name: "linked_target_id", label: "Linked target ID", type: "number", value: item.linked_target_id || "" },
],
},
{
title: "Achievement narrative",
fields: [
{ name: "description", label: "Description", type: "textarea", full: true, value: item.description || "" },
{ name: "child_voice", label: "Child voice", type: "textarea", full: true, value: item.child_voice || "" },
{ name: "archived", label: "Archived", type: "checkbox", value: !!item.archived },
],
},
],
};
...
guidance: "Keep the task specific, practical and easy to action.",
prompts: [
...
fields: [
{ name: "title", label: "Title", type: "text", value: item.title || "" },
{ name: "task", label: "Task description", type: "textarea", full: true, value: item.task || item.summary || "" },
{ name: "task_type", label: "Task type", type: "text", value: item.task_type || "" },
{ name: "assigned_role", label: "Assigned role", type: "text", value: item.assigned_role || "" },
{ name: "due_date", label: "Due date", type: "date", value: item.due_date || "" },
{ name: "completed", label: "Completed", type: "checkbox", value: !!item.completed },
],
},
],
};
...
if (recordType === "safeguarding_record") {
return {
title: item?.id ? "Edit safeguarding record" : "New safeguarding record",
subtitle: "Record safeguarding concerns clearly, factually and safely.",
guidance: "Capture what the concern is, immediate action taken, referrals and outcome.",
prompts: [
"What is the concern?",
...
fields: [
{ name: "safeguarding_category", label: "Category", type: "text", value: item.safeguarding_category || "" },
{ name: "concern_datetime", label: "Concern date and time", type: "datetime-local", value: toDateTimeLocalValue(item.concern_datetime) || now },
{ name: "incident_id", label: "Linked incident ID", type: "number", value: item.incident_id || "" },
],
},
{
title: "Safeguarding narrative",
fields: [
{ name: "disclosure_details", label: "Disclosure details", type: "textarea", full: true, value: item.disclosure_details || "" },
{ name: "concern_details", label: "Concern details", type: "textarea", full: true, value: item.concern_details || "" },
{ name: "immediate_action_taken", label: "Immediate action taken", type: "textarea", full: true, value: item.immediate_action_taken || "" },
{ name: "referral_made", label: "Referral made", type: "checkbox", value: !!item.referral_made },
{ name: "referral_details", label: "Referral details", type: "textarea", full: true, value: item.referral_details || "" },
{ name: "outcome", label: "Outcome", type: "textarea", full: true, value: item.outcome || "" },
],
},
],
...
subtitle: "Record a missing episode and the response around it.",
guidance: "Be clear on timing, actions taken, return information and review needs.",
prompts: [
...
fields: [
{ name: "start_datetime", label: "Start date and time", type: "datetime-local", value: toDateTimeLocalValue(item.start_datetime) || now },
{ name: "reported_datetime", label: "Reported date and time", type: "datetime-local", value: toDateTimeLocalValue(item.reported_datetime) || "" },
{ name: "return_datetime", label: "Return date and time", type: "datetime-local", value: toDateTimeLocalValue(item.return_datetime) || "" },
{ name: "police_reference", label: "Police reference", type: "text", value: item.police_reference || "" },
{ name: "return_interview_completed", label: "Return interview completed", type: "checkbox", value: !!item.return_interview_completed },
{ name: "return_interview_date", label: "Return interview date", type: "date", value: item.return_interview_date || "" },
{ name: "review_required", label: "Review required", type: "checkbox", value: !!item.review_required },
{ name: "linked_risk_assessment_id", label: "Linked risk assessment ID", type: "number", value: item.linked_risk_assessment_id || "" },
],
},
{
title: "Episode narrative",
fields: [
{ name: "trigger_factors", label: "Trigger factors", type: "textarea", full: true, value: item.trigger_factors || "" },
{ name: "push_pull_factors", label: "Push / pull factors", type: "textarea", full: true, value: item.push_pull_factors || "" },
{ name: "actions_taken", label: "Actions taken", type: "textarea", full: true, value: item.actions_taken || "" },
{ name: "outcome", label: "Outcome", type: "textarea", full: true, value: item.outcome || "" },
{ name: "child_voice", label: "Child voice", type: "textarea", full: true, value: item.child_voice || "" },
{ name: "manager_review_status", label: "Manager review status", type: "text", value: item.manager_review_status || "" },
{ name: "workflow_status", label: "Workflow status", type: "text", value: item.workflow_status || "" },
],
},
],
};
