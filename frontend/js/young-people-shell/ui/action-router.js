...
function inferSectionForRecordType(recordType = "", scope = getCurrentScope()) {
  const map = {
    ...
    inspection_refresh: scope === "quality" ? "inspection evidence preparation" : "inspection evidence preparation",
    inspection_sync: scope === "quality" ? "inspection evidence preparation" : "inspection evidence preparation",
