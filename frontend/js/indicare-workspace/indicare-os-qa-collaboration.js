...
function handleQaClicks(event) {
  ...
  if (event.target.closest?.("[data-ai-inspection evidence preparation]")) return ai(event, "Run an Inspection evidence preparation check from the current OS context. Identify evidence strengths, gaps, overdue actions and what a manager should review today.");
