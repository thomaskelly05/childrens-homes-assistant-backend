...
function handleQaClicks(event) {
  ...
  if (event.target.closest?.("[data-ai-inspection-readiness]")) return ai(event, "Run an inspection readiness check from the current OS context. Identify evidence strengths, gaps, overdue actions and what a manager should review today.");
