...
async def upload_referral_document(
    ...
    extracted_text, extraction_method = _extract_text(safe_name, file.content_type, content)
    ...
    payload = {
        ...
        "extracted_text": extraction.get("extracted_text") or extracted_text or "",
        "extracted_metadata": {
            ...
            "requires_manual_review": extraction_method in {
                "pdf_lightweight_fallback",
                "unsupported_binary_saved_only",
            },
    ...
    return gold_standard_response(
        ...
        workflow={
            ...
            "upload_status": extraction.get("extraction_status"),
            "method": extraction_method,
        },
        sync={
            "attempted": False,
            "reason": "referral_upload_pre_placement",
        },
