    ...
    with conn.cursor(cursor_factory=RealDictCursor) as cur:
        cur.execute(
            ...
            SELECT
                ...
                yp.updated_at,
                h.name AS home_name,
                CONCAT(COALESCE(u.first_name, ''), CASE WHEN u.first_name IS NOT NULL AND u.last_name IS NOT NULL THEN ' ' ELSE '' END, COALESCE(u.last_name, '')) AS primary_keyworker_name
