(function(){
  ...
  function installVoice(){window.IndiCareVoice={supported:!!(window.SpeechRecognition||window.webkitSpeechRecognition),create:voice};}
  expose();installVoice();installFetchMemory();
})();
