# ORB Residential — Guide to the Children's Homes Regulations including the Quality Standards — Named Source Sign-Off Review Pack
...
| Field | Value |
|---|---|
| Source title | Guide to the Children's Homes Regulations including the Quality Standards |
| Source ID | `dfe_childrens_homes_regulations_guide` |
| Official URL | https://www.gov.uk/government/publications/childrens-homes-regulations-including-quality-standards-guide |
| Publisher | Department for Education |
| Jurisdiction | England |
| Source kind | DfE practice guidance |
...
- **Chunk artefact path:** `data/orb_residential_ingestion/guide_to_childrens_homes_regulations_chunks.json`
- **Chunk checksum (SHA-256):** `2b18519d5c0cb719156081e5233a1ba900b95a7f0678380a3c2bb888574baaad`
...
- safer recording, reflection and quality of care
...
- Legal advice or statutory compliance decisions
...
| Workflow | Role | Notes |
|---|---|---|
| Daily record / child-centred writing (`daily_record`) | primary | — |
| Incident reflection (`incident_reflection`) | primary | — |
| Regulation 40 / notifiable event question (`reg_40_notification`) | secondary | if practice context is relevant |
| Ofsted evidence / inspection preparation (`ofsted_evidence_preparation`) | secondary | for care quality context |
| Care planning / risk / safeguarding (`care_planning_risk_safeguarding`) | primary | — |
