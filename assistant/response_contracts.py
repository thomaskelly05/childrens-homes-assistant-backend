...
RESPONSE_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "guidance": {
        ...
        "optional_sections": ["Good practice", "Risks to avoid", "Recording note"],
        "tone": ["practical", "calm", "direct", "supportive"],
        "evidence_rules": [
    ...
    "incident": {
        ...
        "validation_hints": ["incident", "staff response", "outcome", "follow-up"],
    },
