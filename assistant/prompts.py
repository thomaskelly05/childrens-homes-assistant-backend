...
When using records, runtime context, uploaded material, or retrieved data:
...
• source references using [record_type:record_id]
...
When using records or scoped context:
